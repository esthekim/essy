...
coverflowimages({
  coverid: 'coverflow1',
  images: [
    ['1.jfif', '1.jfif', 'SRHR advocate'],
    ['2.jfif', '2.jfif', 'protecting a girl is promoting her future '],
    ['3.jfif', '3.jfif', 'say no to Gender Based Violence'],
    ['3.jfif', '3.jfif', 'jkuat model'],
    ['1.jfif', '1.jfif', 'fashion is life'],
    ['2.jfif', '2.jfif', 'keeping it real']
  ]
});
